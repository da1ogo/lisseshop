<template>
  <div class="relative inline-flex">
    ...
    >
      <div
        v-show="dropdownOpen"
        class="absolute top-full z-10 mt-1 min-w-44 origin-top-right overflow-hidden rounded border border-gray-200 bg-white py-1.5 shadow-lg"
        :class="align === 'right' ? 'right-0' : 'left-0'"
      >
        <div class="px-3 pb-2 pt-1.5 text-xs font-semibold uppercase text-gray-400">Need help?</div>
        <ul ref="dropdown" @focusin="dropdownOpen = true" @focusout="dropdownOpen = false">
          <li>
            ...
            >
              <svg class="mr-2 h-3 w-3 shrink-0 fill-current text-indigo-300" viewBox="0 0 12 12">
